...
export default {
  ...
  data() {
    return {
      picList: ['Ethereum', 'BSC', 'Polygon', 'Heco', 'OKExChain', 'Avalanche', 'Harmony', 'KCC', 'Cronos', 'Arbitrum', 'Fantom', 'NERVE'],
      currentIndex: 0,
      showCoinList: [],
      searchVal: '',
      allList: [],
      ...
      handler(val) {
        if (val) {
          ...
          if (this.modalType === 'receive') {
            ...
            this.picList = ['Ethereum', 'BSC', 'Polygon', 'Heco', 'OKExChain', 'Avalanche', 'Harmony', 'KCC', 'Cronos', 'Arbitrum', 'Fantom', 'NERVE'];

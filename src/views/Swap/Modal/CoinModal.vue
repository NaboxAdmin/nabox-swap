...
export default {
  ...
  data() {
    return {
      picList: ['Ethereum', 'BSC', 'Polygon', 'Heco', 'OKTC', 'Avalanche', TRON, 'Harmony', 'KCC', 'Cronos', 'Arbitrum', 'zkSync', 'ETC', 'Fantom', 'Optimism', 'IoTeX', 'Metis', 'Klaytn', 'Aurora', 'Gnosis', 'smartBCH', 'REI', 'KavaEVM', 'ETHW', 'NULS', 'ENULS', 'NERVE'],
      currentIndex: 0,
      showCoinList: [],
      searchVal: '',
      allList: [],
      ...
      handler(val) {
        if (val) {
          ...
          if (this.modalType === 'receive') {
            ...
            this.picList = ['Ethereum', 'BSC', 'Polygon', 'Heco', 'OKTC', 'Avalanche', TRON, 'Harmony', 'KCC', 'Cronos', 'Arbitrum', 'zkSync', 'ETC', 'Fantom', 'Optimism', 'IoTeX', 'Metis', 'Klaytn', 'Aurora', 'Gnosis', 'smartBCH', 'REI', 'KavaEVM', 'ETHW', 'NULS', 'ENULS', 'NERVE'];

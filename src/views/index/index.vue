<template>
  <div v-loading="loading" class="main-cont">
    ...
    <template v-if="!isDapp">
      <div
        ...
        class="tab-cont d-flex align-items-center space-between font-500 size-36">
        <div
    ...
    <template v-if="false">
      <header-bar
        ...
        <div :class="{'p-3': showType === 'Swap'}">
          <div :class="{'swap-wrapper': showType === 'Swap' || showType === 'Transfer'}" class="bg-white">
            <Swap
              v-if="showType==='Swap'"
              :is-dapp="isDapp"
              :from-network="fromNetwork"
